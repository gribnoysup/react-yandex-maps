...
> `WARN` Controlled props that are mentioned above are not 100% controlled as there is
...
Rendering React DOM nodes to the Yandex.Maps template factories is not supported yet
