!(function(e, t) {
    ...
    for (var a in e)
      if (v(e, a)) {
        ...
        if (
          ...
          m[i.message] = !0;
          var u = r ? r() : '';
          y('Failed ' + n + ' type: ' + i.message + (null != u ? u : ''));
        }
      }
  }
  (y = function(e) {
          ...
          a = {
            ...
            oneOfType: function(e) {
              ...
              return u(function(t, n, o, r, a) {
                for (var s = [], u = 0; u < e.length; u++) {
                  var p = (0, e[u])(t, n, o, r, a, l);
                  if (null == p) return null;
                  p.data &&
                    d(p.data, 'expectedType') &&
                    s.push(p.data.expectedType);
                }
                return new i(
                  'Invalid ' +
                    r +
            ...
            shape: function(e) {
              return u(function(t, n, o, r, a) {
                ...
                for (var p in e) {
                  var f = e[p];
                  if ('function' != typeof f) return c(o, r, a, p, m(f));
                  var d = f(s, p, o, r, a + '.' + p, l);
                  if (d) return d;
                }
                return null;
              });
        ...
        var d = (function(t) {
          function n() {
            ...
            for (var r = arguments.length, a = Array(r), i = 0; i < r; i++)
              a[i] = arguments[i];
            return (
              (e = o = u(this, t.call.apply(t, [this].concat(a)))),
      ...
      return (
        ...
        (a.prototype.render = function() {
          var o = this.props.ymaps,
            ...
            a = S(this.props, ['onLoad', 'onError', 'modules', 'ymaps']);
          return (
  ...
  var ue = k(I(se, !0, ['control.GeolocationControl']));
  function pe(e) {
  ...
  var ce = k(I(pe, !0, ['control.ListBox']));
  function fe(e) {
  ...
  var Se = k(I(we, !0, ['control.TrafficControl']));
  function Ee(e) {
  ...
  var Re = k(I(Ee, !0, ['control.TypeSelector']));
  function Te(e) {
  ...
  var Pe = k(I(Te, !0, ['control.ZoomControl'])),
    xe = (function(e) {
      function n() {
        e.call(this), (this.state = { instance: null });
      }
  ...
  var dt,
    ...
    Tt = wt(
      ...
      ? wt
      : function(e) {
          return jt(e) && Et.call(e, 'callee') && !Rt.call(e, 'callee');
        },
    Pt = Array.isArray,
    xt = $e ? $e.isConcatSpreadable : void 0,
    Ct = function(e) {
      return Pt(e) || Tt(e) || !!(xt && e && e[xt]);
    },
    Mt = function(e) {
      return e;
    },
  ...
  (e.withYMaps = I),
    ...
    (e.Panorama = te),
    (e.Button = re),
    (e.FullscreenControl = ie),
    (e.GeolocationControl = ue),
    (e.ListBox = ce),
    (e.ListBoxItem = le),
    (e.RouteButton = ye),
    (e.RouteEditor = me),
