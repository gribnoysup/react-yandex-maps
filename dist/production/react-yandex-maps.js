...
var re,
    ...
    return Pe(
      (function(t, e, n) {
        return (
          ...
          function() {
            for (
              var o = arguments, r = -1, i = we(o.length - e, 0), s = Array(i);
              ++r < i;
  ...
  Ae = W(
    N(
      function(t) {
        return e.createElement(Me, Object.assign({}, t, { name: 'Circle' }));
      },
      !0,
      ['Circle']
    )
  ...
  ke = W(
    N(
      function(t) {
        return e.createElement(Me, Object.assign({}, t, { name: 'Placemark' }));
      },
      !0,
      ['Placemark']
    )
  ...
  Ue = W(
    N(
      function(t) {
        return e.createElement(Me, Object.assign({}, t, { name: 'Polygon' }));
      },
      !0,
      ['Polygon']
    )
  ...
  ze = W(
    N(
      function(t) {
        return e.createElement(Me, Object.assign({}, t, { name: 'Polyline' }));
      },
      !0,
      ['Polyline']
    )
  ...
  Be = W(
    N(
      function(t) {
        return e.createElement(Me, Object.assign({}, t, { name: 'Rectangle' }));
      },
      !0,
      ['Rectangle']
    )
...
(exports.withYMaps = N),
  ...
  (exports.Panorama = at),
  (exports.Button = ut),
  (exports.FullscreenControl = pt),
  (exports.GeolocationControl = ft),
  (exports.ListBox = lt),
  (exports.ListBoxItem = dt),
  (exports.RouteButton = ht),
  (exports.RouteEditor = yt),
  (exports.RoutePanel = mt),
  (exports.RulerControl = vt),
  (exports.SearchControl = bt),
  (exports.TrafficControl = _t),
  (exports.TypeSelector = gt),
  (exports.ZoomControl = jt),
  (exports.Clusterer = Ot),
  (exports.ObjectManager = Se),
  (exports.GeoObject = $e),
  (exports.Circle = Ae),
  (exports.Placemark = ke),
  (exports.Polygon = Ue),
  (exports.Polyline = ze),
  (exports.Rectangle = Be);
